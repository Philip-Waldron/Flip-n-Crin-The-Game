...
public class RopeController : MonoBehaviour 
{
    ...
    //Rope data
    public float RopeSectionLength = 2f;

    //Data we can change to change the properties of the rope
    //Spring constant
    public float SprintConstant = 40f;
    //Damping from rope friction constant
    public float FrictionDampening = 2f;
    //Damping from air resistance constant
    public float AirDampening = 0.05f;
    //Mass of one rope section
    public float RopeSectionMass = 0.2f;

    public int SectionCount = 7;
    ...
    private List<Vector3> CalculateAccelerations(List<RopeSection> allRopeSections)
    {
        ...
        //Spring constant
        float k = SprintConstant;
        //Damping constant
        float d = FrictionDampening;
        //Damping constant from air resistance
        float a = AirDampening;
        //Mass of one rope section
